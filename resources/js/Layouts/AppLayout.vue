<template>
    <v-app>
        ...
        >
            <!-- Header Section -->
            <div
                class="pa-5 text-center position-relative"
                style="
            ...
            <v-list class="pa-3" nav>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('Parcels/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('StopDeskPayment/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('Recoltes/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                        <v-icon
                            :color="
                                $page.component.startsWith('ecoltes/')
                                    ? '#667eea'
                                    : '#8b92a8'
                            "
                            size="22"
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('DriverSettlement/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('Expense/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('Drivers/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('WhatsApp/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>
                ...
                <v-list-item
                    ...
                    :class="{
                        'sidebar-item-active':
                            $page.component.startsWith('Companies/'),
                    }"
                    class="sidebar-item mb-1"
                >
                    <template v-slot:prepend>

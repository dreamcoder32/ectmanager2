          ...
          <v-col cols="12" md="8" lg="6">
            <v-card elevation="2" class="pa-4">
              <v-card-title class="text-h5 mb-4">
                <v-icon left color="primary">mdi-tag-edit</v-icon>
                Edit "{{ category.name }}"
              </v-card-title>
              ...
              <v-form @submit.prevent="submit">
                <v-card-text>
                  <v-row>
                    ...
                    <!-- Category Stats -->
                    <v-col cols="12" v-if="category.expenses_count !== undefined">
                      <v-alert
                        type="info"
                        variant="tonal"
                        prepend-icon="mdi-information"
                      >
                        This category has {{ category.expenses_count || 0 }} associated expense(s)
                      </v-alert>
                    </v-col>
                  </v-row>
                </v-card-text>
